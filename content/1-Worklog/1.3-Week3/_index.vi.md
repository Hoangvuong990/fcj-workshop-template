...
| --- | --- | --- | --- | --- |
| 2 | **Khái quát về AWS Support & Các loại yêu cầu hỗ trợ (Support Cases)** <br> - Tìm hiểu tổng quan quy trình truy cập AWS Support và phân biệt các loại case: Hỗ trợ Tài khoản & Thanh toán, Mở rộng giới hạn dịch vụ, và Hỗ trợ kỹ thuật. <br> - Phân tích cơ chế liên lạc Hỗ trợ kỹ thuật: gói Developer (qua email/web), gói Business/Enterprise (qua điện thoại/chat). Lưu ý gói Basic không hỗ trợ tạo case kỹ thuật. | 04/05/2026 | 04/05/2026 | <https://docs.aws.amazon.com/awssupport/> |
| 3 | **Khởi tạo và quản lý Yêu cầu hỗ trợ** <br> - Thực hành các bước thực tế tạo case hỗ trợ kích hoạt tài khoản thủ công: truy cập Support console, chọn **Create case** -> **Account and billing support** (Type: Account, Category: Activation). <br> - Viết tiêu đề và mô tả chi tiết lỗi kèm file ảnh đính kèm. Chọn phương thức liên hệ Chat trực tuyến và gửi yêu cầu. | 05/05/2026 | 05/05/2026 | <https://docs.aws.amazon.com/awssupport/> |
