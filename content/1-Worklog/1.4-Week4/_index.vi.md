...
* Tìm hiểu tổng quan về dịch vụ máy chủ ảo Amazon EC2.
* Nắm vững các khái niệm và thành phần bổ trợ: AMI, EBS, Instance Store, User Data và Metadata.
...
| --- | --- | --- | --- | --- |
| 2 | **Tổng quan về Amazon EC2** <br> - Tìm hiểu khái niệm máy chủ ảo EC2, tính linh hoạt và khả năng co dãn tài nguyên. <br> - Nghiên cứu các nhóm ứng dụng thực tế (web hosting, database, authentication). <br> - Học cách lựa chọn Instance Type phù hợp theo nhu cầu CPU (Intel, AMD, Graviton), Memory, Network và Storage. | 11/05/2026 | 11/05/2026 | <https://docs.aws.amazon.com/ec2/> |
| 3 | **AMI, Cơ chế Sao lưu & Cặp khóa Bảo mật** <br> - Tìm hiểu cách sử dụng AMI để khởi tạo hàng loạt instance đồng bộ chứa sẵn hệ điều hành và cấu hình phần mềm. <br> - Nghiên cứu quy trình sao lưu bằng snapshot cho ổ đĩa EBS. <br> - Tìm hiểu nguyên lý hoạt động của Key Pair (gồm public key lưu trên AWS và private key lưu trên máy cá nhân) để SSH an toàn. | 12/05/2026 | 12/05/2026 | <https://docs.aws.amazon.com/ec2/> |
| 4 | **Lưu trữ dạng khối với Amazon EBS** <br> - Tìm hiểu dịch vụ block storage EBS gắn trực tiếp vào EC2, phân biệt 2 loại ổ đĩa SSD và HDD. <br> - Nghiên cứu thiết kế độ tin cậy cao (99.999% SLA) thông qua việc tự động replicate dữ liệu giữa các storage node trong cùng một Availability Zone (AZ). <br> - Phân tích kiến trúc mạng độc lập của EBS giúp duy trì hoạt động riêng biệt với EC2. | 13/05/2026 | 13/05/2026 | <https://docs.aws.amazon.com/ebs/> |
...
* **Thứ 3 (12/05/2026):** Thành thạo lý thuyết khởi tạo máy từ AMI, cơ chế snapshot bảo vệ dữ liệu và sử dụng cặp khóa để SSH bảo mật.
...
* **Thứ 6 (15/05/2026):** Hiểu cơ chế truy xuất thông tin cấu hình qua Metadata thông qua địa chỉ IP Link-Local và nguyên lý co dãn tự động kết hợp Load Balancer trên nhiều AZ.
