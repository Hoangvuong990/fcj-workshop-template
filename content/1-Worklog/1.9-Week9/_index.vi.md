...
* Lập trình các trạng thái tương tác người dùng như tải dữ liệu (loading state) và thông báo lỗi (error handling).
...
| 4 | **Xử lý trạng thái tải (Loading state) & các trạng thái lỗi** <br> - Thiết kế và lập trình giao diện chờ (skeleton loaders hoặc spin indicator) trong thời gian chờ AI xử lý lịch trình. <br> - Viết code bắt lỗi (try/catch) để xử lý các mã lỗi HTTP (400, 500) khi API bị gián đoạn. | 17/06/2026 | 17/06/2026 | |
...
* **Thứ 5 (18/06/2026):** Hoàn thành buổi review chéo code và thực hiện tái cấu trúc (refactor) một số hàm xử lý API của Frontend.
