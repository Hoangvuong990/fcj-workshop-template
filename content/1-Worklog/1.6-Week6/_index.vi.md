...
| 6 | **Tổng kết Database & Đánh giá bảo mật với AWS Security Hub** <br> - **Database Recap**: So sánh điểm khác biệt cốt lõi giữa Amazon RDS và Amazon Redshift. <br> - **AWS Security Hub**: Tìm hiểu cơ chế Security Hub tự động kiểm tra cấu hình theo tiêu chuẩn ngành (PCI DSS), chấm điểm bảo mật, quét liên tục để nhận diện rủi ro cấu hình sai. <br> - **Ôn tập tổng kết**: Review các dịch vụ bảo mật trong tuần (Organizations, Identity Center, KMS, Security Hub). | 29/05/2026 | 29/05/2026 | <https://docs.aws.amazon.com/securityhub/> |
