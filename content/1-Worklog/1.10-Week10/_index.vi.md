...
* Xây dựng giao diện hiển thị lịch trình hành trình chi tiết theo trục thời gian và tích hợp bản đồ trực quan.
* Tối ưu hóa khả năng hiển thị tương thích trên các thiết bị di động.
* Tham gia kiểm thử hệ thống từ đầu đến cuối và phối hợp sửa lỗi.
...
| 5 | **Tham gia kiểm thử End-to-End lần đầu** <br> - Kết nối hoàn chỉnh từ giao diện Frontend qua API Gateway đến Lambda AI và hiển thị dữ liệu lịch trình thực tế. <br> - Thực hiện kiểm thử toàn bộ luồng sử dụng cùng cả nhóm (bấm nút → nhận lịch trình trực tiếp). | 25/06/2026 | 25/06/2026 | |
...
* **Thứ 4 (24/06/2026):** Tối ưu hóa thành công giao diện tương thích giúp hiển thị mượt mà trên thiết bị di động.
